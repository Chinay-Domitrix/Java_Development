...
public final class p425 extends EulerSolution {
	...
	@NotNull String run() {
		...
		long sum = IntStream.range(0, isPrime.length).filter(i -> isPrime[i] && pathMax[i] > i).asLongStream().sum();
