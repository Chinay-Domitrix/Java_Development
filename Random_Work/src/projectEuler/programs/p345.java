...
public final class p345 extends EulerSolution {
	...
	private int findMaximumSum(int startRow, int setOfCols) {
		if (startRow == ROWS) {
			assert bitCount(setOfCols) == COLUMNS - ROWS;
			return 0;
		}
