...
public final class p206 extends EulerSolution {
	...
	private static boolean isConcealedSquare(int[] n) {
		// Scan for 1 to 9
		return rangeClosed(1, 9).noneMatch(i -> n[20 - (i * 2)] != i) && (n[0] == 0); // Special case for 0
	}
	...
	@NotNull String run() {
		...
		var ndigits = new int[10]; // In base 10, little-endian
		var n2digits = new int[19]; // Based on length of pattern
		long temp = n;
