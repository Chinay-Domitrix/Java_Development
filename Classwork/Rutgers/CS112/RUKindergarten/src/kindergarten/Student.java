...
public final class Student {
	 ...
	 */
	public int compareNameTo(@NotNull Student other) {
		int lastNameCompare = this.lastName.compareToIgnoreCase(other.getLastName());
		return (lastNameCompare == 0) ? this.firstName.compareToIgnoreCase(other.getFirstName()) : lastNameCompare;
	}
	...
	public @NotNull String print() {
		...
		printName += (lastName.length() > 4) ? this.lastName.substring(0, 4) : lastName;
		return printName;
	}
