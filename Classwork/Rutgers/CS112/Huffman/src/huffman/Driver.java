	...
	public static void main(String[] args) {
		...
		do {
			...
			do {
				...
				switch (choice) {
					case 1 -> testSortedList(input);
					case 2 -> testMakeTree(input);
					case 3 -> testMakeEncodings(input);
					case 4 -> testEncode(input);
					case 5 -> testDecode(input);
					default -> System.err.println("Not a valid method to test!");
				}
