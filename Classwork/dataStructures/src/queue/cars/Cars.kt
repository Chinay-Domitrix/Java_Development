...
fun main() {
	...
	ln(
		"LinkedList:%n%-32s%-32s%-32s%-32s%-32s%-32s%-32s%-32s".format(
			"ID",
			"MPG",
			"Engine Size",
			"Horsepower",
	...
	ln(
		"%nStack:%n%-32s%-32s%-32s%-32s%-32s%-32s%-32s%-32s".format(
			"ID",
			"MPG",
			"Engine Size",
			"Horsepower",
	...
	ln(
		"%nPriorityQueue:%n%-32s%-32s%-32s%-32s%-32s%-32s%-32s%-32s".format(
			"ID",
			"MPG",
			"Engine Size",
			"Horsepower",
...
data class Car(
	...
	override fun toString() = "%-32s%-32s%-32s%-32s%-32s%-32s%-32s%-32s".format(
		carID,
		mpg,
		engineSize,
		horsepower,
