...
public class WiggleBlock extends Block {
	...
	public void move() {
		...
		if (((wiggleDirection >= 0) && (wiggleDirection < 90))
				|| ((wiggleDirection >= 270) && (wiggleDirection <= 360)))
			yInc++;
		if ((wiggleDirection > 90) && (wiggleDirection < 270))
			yInc--;
		if ((wiggleDirection > 0) && (wiggleDirection < 180))
			xInc++;
		if ((wiggleDirection > 180) && (wiggleDirection < 360))
			xInc--;
