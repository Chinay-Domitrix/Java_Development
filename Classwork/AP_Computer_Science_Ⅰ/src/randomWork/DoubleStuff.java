...
/**
 * This class is used to demonstrate how doubles behave under unusual circumstances.
 * Inspect the code and determine what it will do.
 * - How is division by zero handled?
 * - Are theoretically equal doubles always equal in practice?
 * - How can setting a tolerance be used check equality with doubles?
 * Exercise: How many terms does it take for the series below to converge to within 0.00001 of 2
...
//		Limits of testing equality with doubles
		...
		out.println("3 * 1/7000 == 3/7000? " + (3 * one_seventhousandth == three_seventhousandths));     // Why is this false?
